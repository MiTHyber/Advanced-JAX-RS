...
public class ShortLocalDateTimeMessageBodyWriter implements MessageBodyWriter<LocalDateTime> {
	...
	String shortDate = t.getDayOfMonth() + "-" + t.getMonth() + "-" + t.getYear();
	entityStream.write(shortDate.toString()
		.getBytes());
    }
